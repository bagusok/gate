...
async function getTermsConditions() {
	const setting = await db.query.siteSettings.findFirst({
		where: eq(siteSettings.key, "terms_conditions"),
	});
	return {
...
export default async function TermsPage() {
	const [data, session] = await Promise.all([getTermsConditions(), getSession()]);
					...
					<div className="container relative mx-auto px-4 py-16 sm:py-20 lg:py-24">
						<div className="max-w-3xl mx-auto text-center">
							...
							<p className="text-lg text-muted-foreground">
								Please read these terms carefully before using our services. By using our API, you
					...
					<div className="max-w-3xl mx-auto">
						{data.content ? (
							...
							<div className="text-center py-16">
								...
								<h2 className="text-xl font-semibold mb-2">Terms Coming Soon</h2>
								<p className="text-muted-foreground max-w-md mx-auto">
									Our terms and conditions are being prepared. Please check back later or contact us
